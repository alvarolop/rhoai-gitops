...
NOTE: RHOAI is a product under continuous improvement, so probably this repo will be outdated at some point in time. I recommend you to refer to the https://access.redhat.com/documentation/en-us/red_hat_openshift_ai_self-managed/2.8[Official documentation] to check the latest features!
