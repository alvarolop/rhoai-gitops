...
image::distributed-workload-metrics.png["Distributed Workload - Metrics", width=70%]

image::distributed-workload-status.png["Distributed Workload - Status", width=70%]
...
OpenShift AI now includes the posibility to deploy a model registries to store community and customized AI models. 
